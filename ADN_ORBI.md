# 🧬 ADN del Proyecto: ORBI Ecosystem

Este documento define la identidad, arquitectura técnica y estrategia de crecimiento de **ORBI**, una plataforma integral que fusiona un sitio web corporativo de alto impacto con un CRM a medida para la gestión operativa y de marketing.

---

## 🕒 Integridad de Datos: Estandarización Horaria
Para garantizar la precisión en reportes de obra, agendamiento de personal y notificaciones automáticas, el ecosistema **ORBI** opera bajo una única fuente de verdad temporal:
...
*   **Empresa**: ORBI (RUC 1105048852001)
...
El sitio web [www.orbi.com](http://www.orbi.com) está diseñado como una máquina de ventas de 20 páginas con intención de búsqueda (Search Intent) y SEO On-Page.
...
## 3. Arquitectura del CRM Orbi (El Motor)
...
El sistema centraliza las consultas de las 3 sucursales de ORBI a través de un canal de WhatsApp inteligente que:
...
*   ✅ Capacitación y manuales de uso para el equipo ORBI.
