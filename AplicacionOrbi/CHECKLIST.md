...
- [ ] Instalar dependencias de Capacitor
  ...
  npx cap init "Orbi CRM" "com.orbi.crm" --web-dir=out
  ```
...
- [ ] Decidir modo: **Server URL** vs **Local Build**
  - Server URL: WebView carga `https://crm.orbi.com`
...
- [ ] Splash screen con logo Orbi (#036BB2)
- [ ] Status bar theming (color corporativo)
- [ ] Configurar deep links scheme: `orbi://`
...
- [ ] App listing completo:
  - Nombre: "Orbi CRM — Gestión de Proyectos"
...
- [ ] Página de descarga en web Orbi
