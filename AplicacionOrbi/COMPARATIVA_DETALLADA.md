...
## Para el Contexto de Orbi CRM (Ecuador / LATAM)
...
```
Flujo de instalación:
  1. Abrir Play Store → buscar "Orbi CRM"
  2. Tap "Instalar"
  3. Aceptar permisos
...
**Impacto para Orbi**: Los operadores en campo necesitan recibir notificaciones de tareas/proyectos SIEMPRE. Con Web Push, a veces no llegan. Con FCM, llegarán el 99% del tiempo.
...
## 8. Estrategia Recomendada para Orbi

### Distribución Dual
```
1. PLAY STORE (AAB) — Para usuarios que buscan "Orbi" en la tienda
