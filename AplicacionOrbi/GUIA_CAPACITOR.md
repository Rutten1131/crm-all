# 🔧 Guía de Instalación — Capacitor.js para Orbi CRM
...
```bash
# Desde la raíz del proyecto Orbi CRM
cd "d:\Abel paginas\Orbi\Crm Orbi - cloudfare 4"

# Instalar core
npm install @capacitor/core @capacitor/cli

# Inicializar (NO ejecutar aún, se hará en Fase 1)
# npx cap init "Orbi CRM" "com.orbi.crm"
```
...
const config: CapacitorConfig = {
  ...
  server: {
    url: 'https://crm.orbi.com', // Tu URL de producción
  ...
  plugins: {
    SplashScreen: {
      ...
      launchAutoHide: true,
      backgroundColor: '#036BB2', // Orbi blue
