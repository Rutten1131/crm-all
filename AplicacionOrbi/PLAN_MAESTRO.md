# 📱 Plan Maestro — Orbi CRM: Migración a Aplicación Móvil
...
- [ ] Configurar deep links (`orbi://`)
- [ ] Splash screen + ícono de app
- [ ] Status bar theming (color Orbi `#036BB2`)
...
- [ ] Configurar link de descarga directa (APK) en web Orbi
