...
Tu VPS (donde ya corre el CRM)
  └── /var/www/orbi/public/app-update/
       ├── latest.apk              (última versión)
       ├── orbi-crm-v1.0.1.apk (backup de versión)
       └── version.json            (metadata de versión)

Flujo para el usuario:
  1. Abre link: https://crm.orbi.com/descargar
...
El APK contiene SOLO el shell nativo (WebView)
  → El WebView carga https://crm.orbi.com
...
// /public/app-update/version.json
{
  ...
  "downloadUrl": "https://crm.orbi.com/app-update/latest.apk",
