...
const faqs = [
  ...
  { q: "¿QUÉ MANTENIMIENTO REQUIERE UNA CABINA SECA?", a: "El mantenimiento es mínimo comparado con áreas de vapor total. Orbi provee el recambio de las piedras volcánicas, calibración de generadores, y mantenimiento a los controles digitales para seguridad del usuario." },
]
    ...
    <main className="bg-white min-h-screen overflow-x-hidden pt-[80px]">
      ...
      <section className="relative h-[95vh] flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-5 sm:px-10 w-full max-w-[1000px] mx-auto flex flex-col items-center">
          ...
          >
            Saunas Secos.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004A87] to-[#00D1C8]">El Paraíso en tu Hogar.</span>
          </motion.h1>
