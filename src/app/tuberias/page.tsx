...
const workProcess = [
  { number: "01", title: "Diseño & Hidrodinámica", desc: "Planificación técnica considerando la resistencia de materiales y curvas de presión.", icon: <Users size={20} />, img: "https://cesarweb.b-cdn.net/home/detalle_ingenieria.webp" },
  { number: "02", title: "Topografía GPS", desc: "Levantamientos de terreno para asegurar cobertura uniforme en sistemas de conducción y riego.", icon: <Cpu size={20} />, img: "https://cesarweb.b-cdn.net/home/matriz_frente.webp" },
  { number: "03", title: "Ingeniería de Fluidos", desc: "Selección de tuberías SCH40 o PEAD según la clasificación de presión (hasta 600 PSI).", icon: <Settings size={20} />, img: "https://cesarweb.b-cdn.net/home/equipo_trabajo.webp" },
  { number: "04", title: "Montaje Electromecánico", desc: "Integración con sistemas de bombeo IBAX y tanques hidroneumáticos para presión constante.", icon: <ShieldCheck size={20} />, img: "https://cesarweb.b-cdn.net/home/showroom_interior.webp" },
  { number: "05", title: "Automatización", desc: "Instalación de electroválvulas y controladores inteligentes para gestión eficiente del agua.", icon: <Award size={20} />, img: "https://cesarweb.b-cdn.net/home/locales-lifestyle.webp" }
]

const iconicModels = [
  { name: "Tubería SCH40 RIV", line: "Conducción 330 PSI", href: "#", img: "https://cesarweb.b-cdn.net/home/hero-slider-3.webp" },
  { name: "Tubo Presión PEAD", line: "Flexibilidad 0.80 MPA", href: "#", img: "https://cesarweb.b-cdn.net/home/showroom_interior.webp" },
  { name: "Válvula Senninger", line: "Regulación Precisa", href: "#", img: "https://cesarweb.b-cdn.net/home/detalle_ingenieria.webp" },
  { name: "Controlador Hunter", line: "Automatización X-Core", href: "#", img: "https://cesarweb.b-cdn.net/home/equipo_trabajo.webp" },
]

const faqs = [
  { q: "¿QUÉ MATERIAL ES MEJOR PARA ALTA PRESIÓN?", a: "Para redes que soportan presiones extremas, suministramos Tubería PVC SCH40 con clasificaciones de hasta 600 PSI en diámetros menores y 330 PSI en estándar, garantizando que el sistema no sufra roturas por golpes de ariete o presión de red." },
  { q: "¿CÓMO PREVIENEN LA FORMACIÓN DE SARRO?", a: "Debido a la alta mineralización del agua en la región, recomendamos integrar sistemas antisarro. Estos protegen las conducciones, evitando incrustaciones que actúan como aislantes y reducen el flujo, optimizando así el consumo energético de tus equipos." },
  { q: "¿ES NECESARIO LIMPIAR LOS DEPÓSITOS ANTES?", a: "Aunque no es obligatorio, técnicamente es ideal realizar una limpieza previa. Esto permite que los aditivos y sistemas de tratamiento actúen preventivamente sobre tuberías limpias, asegurando resultados óptimos en menos de 2 semanas." },
  { q: "¿QUÉ DIFERENCIA HAY CON LA TUBERÍA DE DESAGÜE?", a: "Nuestras líneas de conducción hidráulica (SCH40/PEAD) están diseñadas para presión constante. A diferencia de las tuberías de desagüe Plastigama tradicionales, estas soportan esfuerzos mecánicos y químicos superiores para el transporte de agua potable o piscinas." },
  { q: "¿CÓMO GARANTIZAN QUE LA PRESIÓN SEA CONSTANTE?", a: "Integramos tanques hidroneumáticos y bombas de alta eficiencia que estabilizan la red interna, protegiendo así tus tuberías y grifería de las fluctuaciones de presión que suelen ocurrir en la red pública." },
]

export default function TuberiasPage() {
    ...
    <main className="bg-white min-h-screen overflow-x-hidden pt-[80px]">
      ...
      <section className="relative h-[95vh] flex flex-col items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-5 sm:px-10 w-full max-w-[1000px] mx-auto flex flex-col items-center">
          ...
          >
            Tuberías Pro.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#004A87] to-[#00D1C8]">Ingeniería de Fluidos.</span>
          </motion.h1>
      ...
      <section className="section-gap bg-white">
        <div className="central-container flex flex-col items-center">
          <div className="text-center mb-16 md:mb-28 px-4">
            <span className="text-[#004A87] font-black uppercase tracking-[0.6em] md:tracking-[0.8em] text-[8px] md:text-[10px] mb-6 md:mb-8 block font-brand">Material Técnico</span>
            <h2 className="text-4xl md:text-[80px] font-black text-black mb-6 md:mb-8 tracking-tighter uppercase whitespace-normal md:whitespace-nowrap leading-none">Conducción y Control</h2>
        ...
        <div className="orbi-work-left" style={{ 
          ...
          <div style={{ position: 'relative', zIndex: 10, width: '100%' }}>
            <div style={{ marginBottom: '50px' }}>
              <span style={{ color: '#004A87', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '0.6em', fontSize: '10px' }}>Hydraulic Engineering</span>
              <h2 style={{ fontSize: '60px', fontWeight: 900, color: 'black', textTransform: 'uppercase', lineHeight: '1', margin: '20px 0', letterSpacing: '-0.02em' }}>Plan de<br/><span style={{ color: '#004A87' }}>Conducción</span></h2>
        ...
        <div className="orbi-work-right" style={{ 
          ...
          minWidth: 0
           ...
           <div className="quote-form-card" style={{ width: '100%', backgroundColor: 'white', padding: '50px', boxShadow: '50px 50px 0px rgba(0,0,0,0.2)' }}>
              <DynamicQuoteForm categoryName="Tuberías" />
           </div>
        </div>
      </section>
      ...
      {/* Catálogo Universal */}
      <section id="catalogo">
        <UniversalCatalog defaultCategory="Tuberías" />
      </section>
        ...
        <div style={{ width: '100%', margin: '0' }}>
          ...
          <div className="cta-faq-section" style={{ display: 'flex', flexWrap: 'wrap', width: '100%', backgroundColor: '#050505' }}>
              ...
              boxSizing: 'border-box'
               ...
               <div style={{ zIndex: 10, position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                  ...
                  <h2 className="text-3xl md:text-[42px] mb-8" style={{ fontWeight: 900, color: 'white', textTransform: 'uppercase', lineHeight: '1.2', letterSpacing: '0' }}>
                    Control Total<br />
                    <span style={{ color: '#004A87' }}>del Ciclo del Agua</span>
                  </h2>
            ...
            <div className="faq-side" style={{ backgroundColor: '#F9FAFB', padding: '80px 60px', flex: '1 1 50%', maxWidth: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', boxSizing: 'border-box' }}>
               ...
               <div style={{ marginBottom: '50px' }}>
                 <h3 className="text-3xl md:text-[32px]" style={{ fontWeight: 900, textTransform: 'uppercase', color: 'black', lineHeight: '1.2', letterSpacing: '0' }}>Consultas<br/>Técnicas</h3>
