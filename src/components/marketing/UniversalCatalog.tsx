  ...
  return (
    <div className="w-full bg-white section-gap pb-32">
      <style jsx>{`
        ...
        .text-orbi-blue { color: #004A87; }
        .bg-orbi-blue { background-color: #004A87; }
        ...
        <div className="catalog-grid px-0">
          ...
          <aside className="w-full flex flex-col gap-14 text-left">
            ...
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-black border-l-4 border-orbi-blue pl-4">Buscar Equipo</h3>
              <div className="relative">
                <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" size={14} />
                <input 
                  type="text"
                  placeholder="CÓDIGO O MODELO..."
                  className="w-full pl-10 pr-4 py-4 bg-[#F9FAFB] border border-gray-200 text-[10px] font-black uppercase tracking-widest outline-none focus:border-orbi-blue transition-all square-border text-black"
                  value={searchQuery}
            ...
            {/* Categorías */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-black border-l-4 border-orbi-blue pl-4">Categorías</h3>
            ...
            {/* Precio */}
            <div className="flex flex-col gap-4">
              <h3 className="text-[11px] font-black uppercase tracking-[0.3em] text-black border-l-4 border-orbi-blue pl-4">Inversión Máxima</h3>
              <div className="pt-4 px-2">
                ...
                <div className="flex justify-between mt-4">
                  ...
                  <span className="text-[12px] font-black text-orbi-blue tracking-tighter underline">Max. ${isMounted ? maxPrice.toLocaleString() : maxPrice}</span>
                </div>
              </div>
            </div>
                ...
                <AnimatePresence mode="popLayout">
                  {filteredProducts.map((product) => (
                    <motion.div 
                      ...
                      key={product.id}
                      className="group bg-white border border-gray-100 p-3 flex flex-col hover:border-orbi-blue transition-all"
                    >
                      <div 
                      ...
                      >
                         ...
                         <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                            <ZoomIn className="text-orbi-blue" size={32} strokeWidth={1.5} />
                         </div>
                      </div>

                      <div className="p-6 flex flex-col flex-1">
                         <span className="text-[8px] font-black text-gray-300 uppercase tracking-widest mb-2">{product.code}</span>
                         <h4 className="text-[13px] font-black text-black uppercase tracking-tight leading-tight mb-8 group-hover:text-orbi-blue transition-colors">
                           {product.name}
                         </h4>
                         ...
                         <div className="mt-auto pt-6 border-t border-gray-50 flex items-center justify-between">
                            <div className="flex flex-col text-left">
                              ...
                              <span className="text-[16px] font-black text-orbi-blue tracking-tighter">USD {isMounted ? product.price.toLocaleString() : product.price}</span>
                            </div>
                            <Link href="/contacto" className="w-10 h-10 border border-orbi-blue/20 flex items-center justify-center hover:bg-orbi-blue hover:text-white transition-all square-border">
